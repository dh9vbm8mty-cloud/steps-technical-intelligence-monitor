...
- FHWA Search: status=failed; consecutive_failures=23; items=0; http=403; error=403 Client Error: Forbidden for url: https://highways.dot.gov/search?search=pavement%20cooling
...
- Semantic Scholar: status=partial; consecutive_failures=23; items=10; http=200; error=429 Client Error:  for url: https://api.semanticscholar.org/graph/v1/paper/search?query=pavement+surface+temperature+reduction&limit=5&fields=title%2Curl%2Cabstract%2Cyear%2Cauthors%2Cvenue%2CexternalIds%2CpublicationTypes
