...
## Run Counts
- Raw items: 116
- Normalized items: 116
- NEW: 0
- UPDATED: 0
- DUPLICATE / PREVIOUSLY_SEEN: 108
- REJECTED: 8
...
- FHWA Search: status=failed; consecutive_failures=30; items=0; http=403; error=403 Client Error: Forbidden for url: https://highways.dot.gov/search?search=pavement%20cooling
...
- Semantic Scholar: status=partial; consecutive_failures=30; items=15; http=200; error=429 Client Error:  for url: https://api.semanticscholar.org/graph/v1/paper/search?query=pavement+surface+temperature+reduction&limit=5&fields=title%2Curl%2Cabstract%2Cyear%2Cauthors%2Cvenue%2CexternalIds%2CpublicationTypes
