...
## Run Counts
- Raw items: 111
- Normalized items: 111
- NEW: 1
- UPDATED: 0
- DUPLICATE / PREVIOUSLY_SEEN: 102
- REJECTED: 8
...
- Pavement Asset Management | relevance=Reject | status=REJECTED | type=Research Paper | source=Crossref | year=2015 | families=not reported | url=https://doi.org/10.1002/9781119038849
- Evaluating Pavement and Barriers for Noise Mitigation | relevance=Reject | status=REJECTED | type=Research Paper | source=Crossref | year=2015 | families=not reported | url=https://doi.org/10.3141/2502-04
- Global cooling: increasing world-wide urban albedos to offset CO2 | relevance=Reject | status=REJECTED | type=Research Paper | source=OpenAlex | year=2008 | families=not reported | url=https://doi.org/10.1007/s10584-008-9515-9
- Urban canyon albedo and its implication on the use of reflective cool pavements | relevance=Reject | status=REJECTED | type=Research Paper | source=OpenAlex | year=2015 | families=not reported | url=https://doi.org/10.1016/j.enbuild.2015.03.005
...
- FHWA Search: status=failed; consecutive_failures=33; items=0; http=403; error=403 Client Error: Forbidden for url: https://highways.dot.gov/search?search=pavement%20cooling
...
- Semantic Scholar: status=partial; consecutive_failures=33; items=10; http=429; error=429 Client Error:  for url: https://api.semanticscholar.org/graph/v1/paper/search?query=urban+pavement+cooling&limit=5&fields=title%2Curl%2Cabstract%2Cyear%2Cauthors%2Cvenue%2CexternalIds%2CpublicationTypes
